...
import { ChevronRightIcon, PencilIcon, Trash2Icon, MoreVerticalIcon } from "lucide-react";
...
export const MeetingIdViewHeader = ({
    ...
    return (
        <div className="flex items-center justify-between">
            ...
            {/* Without modal = {false} => the dialog that it opens crashes website => Unclickable */}
